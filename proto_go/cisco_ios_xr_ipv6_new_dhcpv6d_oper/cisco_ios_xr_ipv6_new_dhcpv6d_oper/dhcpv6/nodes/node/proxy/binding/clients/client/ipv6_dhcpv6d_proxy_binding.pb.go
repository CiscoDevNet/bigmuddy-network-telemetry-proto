...
type Ipv6Dhcpv6DProxyBinding struct {
	...
	// DHCPV6 SERG state
	SergState uint32 `protobuf:"varint,77,opt,name=serg_state,json=sergState" json:"serg_state,omitempty"`
	// DHCPV6 SERG Intf Role
	SergIntfRole uint32 `protobuf:"varint,78,opt,name=serg_intf_role,json=sergIntfRole" json:"serg_intf_role,omitempty"`
}
...
var fileDescriptor0 = []byte{
	...
	,
}
