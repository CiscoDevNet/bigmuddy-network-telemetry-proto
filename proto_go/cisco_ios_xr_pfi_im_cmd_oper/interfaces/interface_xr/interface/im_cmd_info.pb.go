...
type ImCmdInfo struct {
	...
	// Fast Shutdown flag
	FastShutdown bool `protobuf:"varint,86,opt,name=fast_shutdown,json=fastShutdown" json:"fast_shutdown,omitempty"`
	// Information specific to the encapsulation
	EncapsulationInformation *ImCmdEncapsInfo `protobuf:"bytes,87,opt,name=encapsulation_information,json=encapsulationInformation" json:"encapsulation_information,omitempty"`
	// Information specific to the interface type
	InterfaceTypeInformation *ImCmdIntfTypeInfo `protobuf:"bytes,88,opt,name=interface_type_information,json=interfaceTypeInformation" json:"interface_type_information,omitempty"`
	// Packet and byte rates
	DataRates *StatsdbagDatarate `protobuf:"bytes,89,opt,name=data_rates,json=dataRates" json:"data_rates,omitempty"`
	// Packet, byte and error counters
	InterfaceStatistics *ImCmdIfStats `protobuf:"bytes,90,opt,name=interface_statistics,json=interfaceStatistics" json:"interface_statistics,omitempty"`
	// L2 Protocol Statistics
	L2InterfaceStatistics *StatsData `protobuf:"bytes,91,opt,name=l2_interface_statistics,json=l2InterfaceStatistics" json:"l2_interface_statistics,omitempty"`
	// nV Optical Controller Information
	NvOptical *NvOpticalInterfaceInfo `protobuf:"bytes,92,opt,name=nv_optical,json=nvOptical" json:"nv_optical,omitempty"`
	// This is not supposed to be used. It is a dummy attribute to support ifindex for OC model
	IfIndex uint32 `protobuf:"varint,93,opt,name=if_index,json=ifIndex" json:"if_index,omitempty"`
}
...
type BmMemberData struct {
	...
	PortPriority uint32 `protobuf:"varint,2,opt,name=port_priority,json=portPriority" json:"port_priority,omitempty"`
	...
	UnderlyingLinkId uint32 `protobuf:"varint,4,opt,name=underlying_link_id,json=underlyingLinkId" json:"underlying_link_id,omitempty"`
	// Member's link order number
	LinkOrderNumber uint32 `protobuf:"varint,5,opt,name=link_order_number,json=linkOrderNumber" json:"link_order_number,omitempty"`
	// Location of member
	IccpNode uint32 `protobuf:"varint,6,opt,name=iccp_node,json=iccpNode" json:"iccp_node,omitempty"`
	...
	LacpEnabled string `protobuf:"bytes,8,opt,name=lacp_enabled,json=lacpEnabled" json:"lacp_enabled,omitempty"`
	// Counters data about member link
	Counters *BmLacpCounters `protobuf:"bytes,9,opt,name=counters" json:"counters,omitempty"`
	// Lacp data about member link
	LinkData *BmLacpLinkData `protobuf:"bytes,10,opt,name=link_data,json=linkData" json:"link_data,omitempty"`
	// Mux state machine data
	MemberMuxData *BmMuxData `protobuf:"bytes,11,opt,name=member_mux_data,json=memberMuxData" json:"member_mux_data,omitempty"`
	// Member's type (local/foreign)
	MemberType string `protobuf:"bytes,12,opt,name=member_type,json=memberType" json:"member_type,omitempty"`
	// Member's (short form) name
	MemberName string `protobuf:"bytes,13,opt,name=member_name,json=memberName" json:"member_name,omitempty"`
	// MAC address of this member (deprecated)
	MacAddress *BmMacAddrSt `protobuf:"bytes,14,opt,name=mac_address,json=macAddress" json:"mac_address,omitempty"`
}
...
type ImCmdTunlGreInfo struct {
	...
	DestinationIpAddressLength uint32 `protobuf:"varint,4,opt,name=destination_ip_address_length,json=destinationIpAddressLength" json:"destination_ip_address_length,omitempty"`
	// GRE tunnel TOS
	TunnelTos uint32 `protobuf:"varint,5,opt,name=tunnel_tos,json=tunnelTos" json:"tunnel_tos,omitempty"`
	// GRE tunnel TTL
	TunnelTtl uint32 `protobuf:"varint,6,opt,name=tunnel_ttl,json=tunnelTtl" json:"tunnel_ttl,omitempty"`
	// Key value for GRE Packet
	Key uint32 `protobuf:"varint,7,opt,name=key" json:"key,omitempty"`
	// Keepalive period in seconds
	KeepalivePeriod uint32 `protobuf:"varint,8,opt,name=keepalive_period,json=keepalivePeriod" json:"keepalive_period,omitempty"`
	// Keepalive retry
	KeepaliveMaximumRetry uint32 `protobuf:"varint,9,opt,name=keepalive_maximum_retry,json=keepaliveMaximumRetry" json:"keepalive_maximum_retry,omitempty"`
	// Tunnel GRE Mode
	TunnelMode string `protobuf:"bytes,10,opt,name=tunnel_mode,json=tunnelMode" json:"tunnel_mode,omitempty"`
	// Tunnel Mode Direction
	TunnelModeDirection string `protobuf:"bytes,11,opt,name=tunnel_mode_direction,json=tunnelModeDirection" json:"tunnel_mode_direction,omitempty"`
	// Keepalive State
	KeepaliveState string `protobuf:"bytes,12,opt,name=keepalive_state,json=keepaliveState" json:"keepalive_state,omitempty"`
	// DF Bit State
	DfBitState string `protobuf:"bytes,13,opt,name=df_bit_state,json=dfBitState" json:"df_bit_state,omitempty"`
	// Key Config State
	KeyBitState string `protobuf:"bytes,14,opt,name=key_bit_state,json=keyBitState" json:"key_bit_state,omitempty"`
}
...
var fileDescriptor0 = []byte{
	// 7106 bytes of a gzipped FileDescriptorProto
	,
}
